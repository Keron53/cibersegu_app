...
import { X, MousePointer, Check, RotateCcw, QrCode, FileText, Send } from 'lucide-react'
...
function PDFSignatureViewer({ documentId, documentName, onClose, onPositionSelected }) {
  ...
  const handleSolicitudEnviada = (solicitud) => {
    setMessage('Solicitud de firma enviada exitosamente')
    setShowSolicitarFirma(false)
    // Opcional: cerrar el visor después de enviar la solicitud
    setTimeout(() => {
      onClose()
    }, 2000)
  }
              ...
              {signaturePosition && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              >
                <div className="p-6">
                  ...
                  <SolicitarFirma
                    ...
                    posicionFirma={signaturePosition}
